    ...
    days:[
      ...
      {day:2, mode:"practice", label:"こぼれる", questions:[
        ...
        q1("teahouse-e01-q04", "quick-response", "v-kobosu", 8,
          ...
          {type:"quick-response", options:["お代をいただきます。","気をつけてください。","すぐにお拭きしますので、そのままで。","こぼしましたね。"], correctIndex:2},
        ...
        q1("teahouse-e01-q05", "listening-task", "w-zoukin", 5,
          ...
          {type:"quick-response", options:["新しい茶碗","飲み物","お客様の伝票","拭くための布"], correctIndex:3},
      ...
      {day:3, mode:"challenge", label:"注文が重なる", questions:[
        ...
        q1("teahouse-e01-q07", "reading", "w-kondate", 120,
          ...
          {type:"evidence-choice", options:["何もお出しできません","茶と菓子","茶と菓子と汁物","汁物だけ"], correctIndex:1},
        ...
        q1("teahouse-e01-q08", "listening-task", "w-shoki", 5,
          ...
          {type:"quick-response", options:["座布団","お客様の荷物","使った茶碗や皿","のれん"], correctIndex:2},
        ...
        q1("teahouse-e01-q09", "quick-response", "w-tsuika", 8,
          ...
          {type:"quick-response", options:["お一つまでです。","もうお出ししました。","お会計になさいますか。","追加ですね。かしこまりました。"], correctIndex:3},
        ...
        q1("teahouse-e01-q10", "integrated", "w-kyoushuku", 12,
          ...
          {type:"quick-response", options:["次からお早めに。","お待たせして恐縮です。","お待たせしました。","忙しかったので。"], correctIndex:1},
    ...
    days:[
      {day:1, mode:"learn", label:"品書き", questions:[
        ...
        q2("teahouse-e02-q01", "orthography", "w-chawan", 20,
          ...
          {type:"single-choice", options:["茶碗","茶椀","茶完","茶腕"], correctIndex:0},
        ...
        q2("teahouse-e02-q03", "sentence-building", "w-henkou", 30,
          ...
          {type:"sentence-order", options:["いつでも","前でしたら","ご注文の","出る"], correctIndex:2},
      ...
      {day:2, mode:"practice", label:"言葉を直す", questions:[
        ...
        q2("teahouse-e02-q05", "word-formation", "w-yuge", 20,
          ...
          {type:"single-choice", options:["気","湯","色","水"], correctIndex:0},
        ...
        q2("teahouse-e02-q06", "text-grammar", "w-kotobazukai", 90,
          ...
          {type:"single-choice", options:["献立","客席","食器","言葉遣い"], correctIndex:3},
    ...
    days:[
      {day:1, mode:"learn", label:"席が埋まる", questions:[
        ...
        q3("teahouse-e03-q01", "quick-response", "w-yousu", 8,
          ...
          {type:"quick-response", options:["お休みになっています。","お急ぎのご様子です。","まだ何も召し上がっていません。","おくつろぎのご様子です。"], correctIndex:1},
      ...
      {day:2, mode:"practice", label:"好みを聞く", questions:[
        ...
        q3("teahouse-e03-q04", "listening-task", "w-shokuyoku", 5,
          ...
          {type:"quick-response", options:["食べたい気持ちが起きない","急いでいる","お金が足りない","席が気に入らない"], correctIndex:0},
      ...
      {day:3, mode:"challenge", label:"間違えない", questions:[
        ...
        q3("teahouse-e03-q07", "listening-task", "v-kurikaesu", 5,
          ...
          {type:"quick-response", options:["台所へ走ります。","注文を書き直します。","もう一度注文を聞きます。","聞いた注文をもう一度言います。"], correctIndex:3},
        ...
        q3("teahouse-e03-q10", "integrated", "w-manzoku", 12,
          ...
          {type:"quick-response", options:["お客様は召し上がりませんでした。","不満だったようです。","分かりません。","満足していただけたと思います。"], correctIndex:3},
    ...
    days:[
      {day:1, mode:"learn", label:"のれんを下げる", questions:[
        ...
        q4("teahouse-e04-q02", "listening-task", "v-kawakasu", 5,
          ...
          {type:"quick-response", options:["もう一度洗います。","水気がなくなるまで干します。","水につけます。","たたんでしまいます。"], correctIndex:1},
        ...
        q4("teahouse-e04-q03", "listening-task", "v-shimeru", 5,
          ...
          {type:"quick-response", options:["少し水気が残っている","破れている","汚れている","からからに乾いている"], correctIndex:0},
      ...
      {day:3, mode:"challenge", label:"明日の支度", questions:[
        ...
        q4("teahouse-e04-q07", "text-grammar", "w-shitaku", 90,
          ...
          {type:"single-choice", options:["支度","応対","会計","休憩"], correctIndex:0},
        ...
        q4("teahouse-e04-q08", "text-grammar", "w-junbi", 90,
          ...
          {type:"single-choice", options:["追加","休憩","変更","準備"], correctIndex:3},
        ...
        q4("teahouse-e04-q09", "reading", "w-kyuukei", 120,
          ...
          {type:"evidence-choice", options:["十一時から一時の間","五時から八時の間","一時から五時の間","六時から七時の間"], correctIndex:2},
