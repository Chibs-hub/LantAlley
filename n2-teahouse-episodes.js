    ...
    days:[
      {day:1, mode:"learn", label:"のれんを出す", questions:[
        ...
        q1("teahouse-e01-q01", "quick-response", "w-ukagau", 8,
          ...
          {type:"quick-response", options:["お会計をお願いします。","もう閉まりました。","注文は何。","ご注文を伺います。"], correctIndex:3},
        ...
        q1("teahouse-e01-q02", "listening-task", "w-kyakuseki", 5,
          ...
          {type:"quick-response", options:["お客様が座る場所","二階の倉庫","店の外の道","台所の中"], correctIndex:0},
        ...
        q1("teahouse-e01-q03", "listening-task", "v-sosogu", 5,
          ...
          {type:"quick-response", options:["茶碗を運びます。","茶碗にお茶を入れます。","お茶の葉を捨てます。","茶碗を洗います。"], correctIndex:1},
      ...
      {day:2, mode:"practice", label:"こぼれる", questions:[
        ...
        q1("teahouse-e01-q04", "quick-response", "v-kobosu", 8,
          ...
          {type:"quick-response", options:["気をつけてください。","こぼしましたね。","すぐにお拭きしますので、そのままで。","お代をいただきます。"], correctIndex:2},
        ...
        q1("teahouse-e01-q05", "listening-task", "w-zoukin", 5,
          // The third of this shape, and the same fault as the Inn's 鍵 and the
          // market's 袋: the prompt said 雑巾 and then asked which thing was
          // meant. The prompt names the job now, and 雑巾 is an option.
          {jp:"コン：「畳がぬれています。拭くものを持ってきてください。」何を持ってきますか。", audio:true},
          {type:"quick-response", options:["飲み物","お客様の伝票","新しい茶碗","雑巾"], correctIndex:3},
          {correct:"持ってこられました。「雑巾」は、汚れを拭くための布のことです。",
           incorrect:"汚れを拭くための布は「雑巾」です。"},
          ...
          [
            ...
            "雑巾 - the cloth used for wiping up"
          ]),

        q1("teahouse-e01-q06", "listening-task", "v-fuku", 5,
          {jp:"コン：「畳を拭いてください。」何をしますか。", audio:true},
          {type:"quick-response", options:["布でこすってきれいにします。","水をかけます。","畳を上げます。","そのままにします。"], correctIndex:0},
      ...
      {day:3, mode:"challenge", label:"注文が重なる", questions:[
        ...
        q1("teahouse-e01-q07", "reading", "w-kondate", 120,
          ...
          {type:"evidence-choice", options:["茶と菓子と汁物","茶と菓子","汁物だけ","何もお出しできません"], correctIndex:1},
        ...
        q1("teahouse-e01-q08", "listening-task", "w-shoki", 5,
          ...
          {type:"quick-response", options:["お客様の荷物","のれん","使った茶碗や皿","座布団"], correctIndex:2},
        ...
        q1("teahouse-e01-q09", "quick-response", "w-tsuika", 8,
          ...
          {type:"quick-response", options:["お一杯までです。","もうお出ししました。","お会計になさいますか。","追加ですね。かしこまりました。"], correctIndex:3},
        ...
        q1("teahouse-e01-q10", "integrated", "w-kyoushuku", 12,
          ...
          {type:"quick-response", options:["お待たせしました。","お待たせして恐縮です。","忙しかったので。","次からお早めに。"], correctIndex:1},
    ...
    days:[
      {day:1, mode:"learn", label:"品書き", questions:[
        ...
        q2("teahouse-e02-q01", "orthography", "w-chawan", 20,
          ...
          {type:"single-choice", options:["茶碗","茶腕","茶椀","茶完"], correctIndex:0},
        ...
        q2("teahouse-e02-q02", "word-formation", "w-eigyou", 20,
          ...
          {type:"single-choice", options:["前","切れ","済み","中"], correctIndex:3},
        ...
        q2("teahouse-e02-q03", "sentence-building", "w-henkou", 30,
          ...
          {type:"sentence-order", options:["前でしたら","出る","ご注文の","いつでも"], correctIndex:2},
      ...
      {day:2, mode:"practice", label:"言葉を直す", questions:[
        ...
        q2("teahouse-e02-q04", "orthography", "w-seiketsu", 20,
          ...
          {type:"single-choice", options:["晴潔","清潔","清結","精潔"], correctIndex:1},
        ...
        q2("teahouse-e02-q05", "word-formation", "w-yuge", 20,
          ...
          {type:"single-choice", options:["気","水","湯","色"], correctIndex:0},
        ...
        q2("teahouse-e02-q06", "text-grammar", "w-kotobazukai", 120,
          ...
          {type:"single-choice", options:["食器","献立","客席","言葉遣い"], correctIndex:3},
      ...
      {day:3, mode:"challenge", label:"書き付けを閉じる", questions:[
        ...
        q2("teahouse-e02-q07", "sentence-building", "w-junjo", 30,
          ...
          {type:"sentence-order", options:["出し","後から","菓子を","先に"], correctIndex:2},
        ...
        q2("teahouse-e02-q08", "text-grammar", "w-keigo", 120,
          ...
          {type:"single-choice", options:["順序","敬語","湯気","献立"], correctIndex:1},
        ...
        q2("teahouse-e02-q09", "reading", "w-outai", 120,
          ...
          {type:"evidence-choice", options:["一と二","一と二と四","一だけ","一と二と三"], correctIndex:0},
        ...
        q2("teahouse-e02-q10", "listening-task", "w-uketamawaru", 8,
          ...
          {type:"quick-response", options:["女将さんに伝えます。","お会計をします。","お客様のご注文をお聞きします。","お茶を注ぎます。"], correctIndex:2},
    ...
    days:[
      {day:1, mode:"learn", label:"席が埋まる", questions:[
        ...
        q3("teahouse-e03-q01", "quick-response", "w-yousu", 8,
          ...
          {type:"quick-response", options:["おくつろぎのご様子です。","お急ぎのご様子です。","お休みになっています。","まだ何も召し上がっていません。"], correctIndex:1},
      ...
      {day:2, mode:"practice", label:"好みを聞く", questions:[
        ...
        q3("teahouse-e03-q04", "listening-task", "w-shokuyoku", 5,
          ...
          {type:"quick-response", options:["食べたい気持ちが起きない","お金が足りない","席が気に入らない","急いでいる"], correctIndex:0},
        ...
        q3("teahouse-e03-q06", "reading", "w-konomi", 120,
          ...
          {type:"evidence-choice", options:["二人分の濃いめの茶","何もお出しできません","濃いめの茶と塩味の菓子を一人分","二人分の菓子"], correctIndex:2},
      ...
      {day:3, mode:"challenge", label:"間違えない", questions:[
        ...
        q3("teahouse-e03-q07", "listening-task", "v-kurikaesu", 5,
          ...
          {type:"quick-response", options:["注文を書き直します。","もう一度注文を聞きます。","台所へ走ります。","聞いた注文をもう一度言います。"], correctIndex:3},
        ...
        q3("teahouse-e03-q09", "listening-point", "w-shinchou", 8,
          ...
          {type:"quick-response", options:["急いで運びます。","よく気をつけて、ゆっくり運びます。","たくさん重ねて運びます。","片手で運びます。"], correctIndex:1},
        ...
        q3("teahouse-e03-q10", "integrated", "w-manzoku", 12,
          ...
          {type:"quick-response", options:["不満だったようです。","分かりません。","お客様は召し上がりませんでした。","満足していただけたと思います。"], correctIndex:3},
    ...
    days:[
      {day:1, mode:"learn", label:"のれんを下げる", questions:[
        ...
        q4("teahouse-e04-q02", "listening-task", "v-kawakasu", 5,
          ...
          {type:"quick-response", options:["水につけます。","水気がなくなるまで干します。","たたんでしまいます。","もう一度洗います。"], correctIndex:1},
        ...
        q4("teahouse-e04-q03", "listening-task", "v-shimeru", 5,
          ...
          {type:"quick-response", options:["少し水気が残っている","からからに乾いている","破れている","汚れている"], correctIndex:0},
      ...
      {day:2, mode:"practice", label:"分けて配る", questions:[
        ...
        q4("teahouse-e04-q04", "listening-task", "v-wakeru", 5,
          ...
          {type:"quick-response", options:["明日まで置きます。","捨てます。","全部一人で食べます。","三つに切り分けます。"], correctIndex:3},
        ...
        q4("teahouse-e04-q05", "listening-task", "v-kubaru", 5,
          ...
          {type:"quick-response", options:["女将さんにまとめて渡します。","台所に置いておきます。","一人ずつに手渡します。","客席に並べます。"], correctIndex:2},
      ...
      {day:3, mode:"challenge", label:"明日の支度", questions:[
        ...
        q4("teahouse-e04-q07", "text-grammar", "w-shitaku", 120,
          ...
          {type:"single-choice", options:["支度","休憩","応対","会計"], correctIndex:0},
        ...
        q4("teahouse-e04-q08", "text-grammar", "w-junbi", 120,
          ...
          {type:"single-choice", options:["休憩","変更","追加","準備"], correctIndex:3},
        ...
        q4("teahouse-e04-q09", "reading", "w-kyuukei", 120,
          ...
          {type:"evidence-choice", options:["六時から七時の間","十一時から一時の間","一時から五時の間","五時から八時の間"], correctIndex:2},
        ...
        q4("teahouse-e04-q10", "integrated", "w-touban", 12,
          ...
          {type:"quick-response", options:["明日の朝は私が当番です。","誰でもいいと思います。","当番は決まっていません。","女将さんだと思います。"], correctIndex:0},
