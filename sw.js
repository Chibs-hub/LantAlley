 ...
 */
var CACHE_VERSION = "lantern-alley-v361";
...
var SHELL = [
  ...
  "./icons/icon-192.png?v=361",
  "./icons/icon-512.png?v=361",
  "./icons/icon-192-maskable.png?v=361",
  "./icons/icon-512-maskable.png?v=361",
  "./icons/apple-touch-icon.png?v=361",
