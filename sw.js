 ...
 */
var CACHE_VERSION = "lantern-alley-v421";
...
var SHELL = [
  ...
  "./icons/icon-192.png?v=421",
  "./icons/icon-512.png?v=421",
  "./icons/icon-192-maskable.png?v=421",
  "./icons/icon-512-maskable.png?v=421",
  "./icons/apple-touch-icon.png?v=421",
