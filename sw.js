 ...
 */
var CACHE_VERSION = "lantern-alley-v412";
...
var SHELL = [
  ...
  "./icons/icon-192.png?v=412",
  "./icons/icon-512.png?v=412",
  "./icons/icon-192-maskable.png?v=412",
  "./icons/icon-512-maskable.png?v=412",
  "./icons/apple-touch-icon.png?v=412",
