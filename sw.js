 ...
 */
var CACHE_VERSION = "lantern-alley-v455";// Episode 1 teaches its new words on the word list, not mid-evening.
...
var SHELL = [
  ...
  "./icons/icon-192.png?v=455",
  "./icons/icon-512.png?v=455",
  "./icons/icon-192-maskable.png?v=455",
  "./icons/icon-512-maskable.png?v=455",
  "./icons/apple-touch-icon.png?v=455",
