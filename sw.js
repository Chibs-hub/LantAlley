 ...
 */
var CACHE_VERSION = "lantern-alley-v392";
// Art: the irori carries its jizaikagi in one piece.
...
var SHELL = [
  ...
  "./icons/icon-192-maskable.png?v=392",
  "./icons/icon-512-maskable.png?v=392",
  "./icons/apple-touch-icon.png?v=392",
