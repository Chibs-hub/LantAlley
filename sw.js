 ...
 */
var CACHE_VERSION = "lantern-alley-v329";
...
var SHELL = [
  ...
  "./icons/icon-192.png?v=329",
  "./icons/icon-512.png?v=329",
  "./icons/icon-192-maskable.png?v=329",
  "./icons/icon-512-maskable.png?v=329",
  "./icons/apple-touch-icon.png?v=329",
