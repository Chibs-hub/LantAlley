 ...
 */
var CACHE_VERSION = "lantern-alley-v355";
...
var SHELL = [
  ...
  "./icons/icon-192.png?v=355",
  "./icons/icon-512.png?v=355",
  "./icons/icon-192-maskable.png?v=355",
  "./icons/icon-512-maskable.png?v=355",
  "./icons/apple-touch-icon.png?v=355",
