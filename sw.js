 ...
 */
var CACHE_VERSION = "lantern-alley-v409";
...
var SHELL = [
  ...
  "./icons/icon-192.png?v=409",
  "./icons/icon-512.png?v=409",
  "./icons/icon-192-maskable.png?v=409",
  "./icons/icon-512-maskable.png?v=409",
  "./icons/apple-touch-icon.png?v=409",
