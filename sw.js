 ...
 */
var CACHE_VERSION = "lantern-alley-v420";
...
var SHELL = [
  ...
  "./icons/icon-192.png?v=420",
  "./icons/icon-512.png?v=420",
  "./icons/icon-192-maskable.png?v=420",
  "./icons/icon-512-maskable.png?v=420",
  "./icons/apple-touch-icon.png?v=420",
