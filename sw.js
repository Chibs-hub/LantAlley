 ...
 */
var CACHE_VERSION = "lantern-alley-v441";
...
var SHELL = [
  ...
  "./icons/icon-192.png?v=441",
  "./icons/icon-512.png?v=441",
  "./icons/icon-192-maskable.png?v=441",
  "./icons/icon-512-maskable.png?v=441",
  "./icons/apple-touch-icon.png?v=441",
