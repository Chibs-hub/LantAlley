 ...
 */
var CACHE_VERSION = "lantern-alley-v408";
...
var SHELL = [
  ...
  "./icons/icon-192.png?v=408",
  "./icons/icon-512.png?v=408",
  "./icons/icon-192-maskable.png?v=408",
  "./icons/icon-512-maskable.png?v=408",
  "./icons/apple-touch-icon.png?v=408",
