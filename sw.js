 ...
 */
var CACHE_VERSION = "lantern-alley-v349";
...
var SHELL = [
  ...
  "./icons/icon-192.png?v=349",
  "./icons/icon-512.png?v=349",
  "./icons/icon-192-maskable.png?v=349",
  "./icons/icon-512-maskable.png?v=349",
  "./icons/apple-touch-icon.png?v=349",
