 ...
 */
var CACHE_VERSION = "lantern-alley-v397";
...
var SHELL = [
  ...
  "./icons/icon-192.png?v=397",
  "./icons/icon-512.png?v=397",
  "./icons/icon-192-maskable.png?v=397",
  "./icons/icon-512-maskable.png?v=397",
  "./icons/apple-touch-icon.png?v=397",
