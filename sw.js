 ...
 */
var CACHE_VERSION = "lantern-alley-v416";
...
var SHELL = [
  ...
  "./icons/icon-192.png?v=416",
  "./icons/icon-512.png?v=416",
  "./icons/icon-192-maskable.png?v=416",
  "./icons/icon-512-maskable.png?v=416",
  "./icons/apple-touch-icon.png?v=416",
