 ...
 */
var CACHE_VERSION = "lantern-alley-v373";
...
var SHELL = [
  ...
  "./icons/icon-192.png?v=373",
  "./icons/icon-512.png?v=373",
  "./icons/icon-192-maskable.png?v=373",
  "./icons/icon-512-maskable.png?v=373",
  "./icons/apple-touch-icon.png?v=373",
