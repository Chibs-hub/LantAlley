 ...
 */
var CACHE_VERSION = "lantern-alley-v345";
...
var SHELL = [
  ...
  "./icons/icon-192.png?v=345",
  "./icons/icon-512.png?v=345",
  "./icons/icon-192-maskable.png?v=345",
  "./icons/icon-512-maskable.png?v=345",
  "./icons/apple-touch-icon.png?v=345",
