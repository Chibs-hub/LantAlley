 ...
 */
var CACHE_VERSION = "lantern-alley-v456";// The Inn room is drawn larger on a phone; old items are labelled.
...
var SHELL = [
  ...
  "./icons/icon-192.png?v=456",
  "./icons/icon-512.png?v=456",
  "./icons/icon-192-maskable.png?v=456",
  "./icons/icon-512-maskable.png?v=456",
  "./icons/apple-touch-icon.png?v=456",
