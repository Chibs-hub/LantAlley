 ...
 */
var CACHE_VERSION = "lantern-alley-v347";
...
var SHELL = [
  ...
  "./icons/icon-192.png?v=347",
  "./icons/icon-512.png?v=347",
  "./icons/icon-192-maskable.png?v=347",
  "./icons/icon-512-maskable.png?v=347",
  "./icons/apple-touch-icon.png?v=347",
