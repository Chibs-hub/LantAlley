 ...
 */
var CACHE_VERSION = "lantern-alley-v413";
...
var SHELL = [
  ...
  "./icons/icon-192.png?v=413",
  "./icons/icon-512.png?v=413",
  "./icons/icon-192-maskable.png?v=413",
  "./icons/icon-512-maskable.png?v=413",
  "./icons/apple-touch-icon.png?v=413",
