 ...
 */
var CACHE_VERSION = "lantern-alley-v346";
...
var SHELL = [
  ...
  "./icons/icon-192.png?v=346",
  "./icons/icon-512.png?v=346",
  "./icons/icon-192-maskable.png?v=346",
  "./icons/icon-512-maskable.png?v=346",
  "./icons/apple-touch-icon.png?v=346",
