 ...
 */
var CACHE_VERSION = "lantern-alley-v390";
...
var SHELL = [
  ...
  "./icons/icon-512.png?v=390",
  "./icons/icon-192-maskable.png?v=390",
  "./icons/icon-512-maskable.png?v=390",
  "./icons/apple-touch-icon.png?v=390",
