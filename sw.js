 ...
 */
var CACHE_VERSION = "lantern-alley-v357";
...
var SHELL = [
  ...
  "./icons/icon-192.png?v=357",
  "./icons/icon-512.png?v=357",
  "./icons/icon-192-maskable.png?v=357",
  "./icons/icon-512-maskable.png?v=357",
  "./icons/apple-touch-icon.png?v=357",
