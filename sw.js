 ...
 */
var CACHE_VERSION = "lantern-alley-v331";
...
var SHELL = [
  ...
  "./icons/icon-192.png?v=331",
  "./icons/icon-512.png?v=331",
  "./icons/icon-192-maskable.png?v=331",
  "./icons/icon-512-maskable.png?v=331",
  "./icons/apple-touch-icon.png?v=331",
