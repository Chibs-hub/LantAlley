 ...
 */
var CACHE_VERSION = "lantern-alley-v396";
...
var SHELL = [
  ...
  "./icons/icon-192.png?v=396",
  "./icons/icon-512.png?v=396",
  "./icons/icon-192-maskable.png?v=396",
  "./icons/icon-512-maskable.png?v=396",
  "./icons/apple-touch-icon.png?v=396",
