 ...
 */
var CACHE_VERSION = "lantern-alley-v414";
...
var SHELL = [
  ...
  "./icons/icon-192.png?v=414",
  "./icons/icon-512.png?v=414",
  "./icons/icon-192-maskable.png?v=414",
  "./icons/icon-512-maskable.png?v=414",
  "./icons/apple-touch-icon.png?v=414",
