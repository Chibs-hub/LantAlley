 ...
 */
var CACHE_VERSION = "lantern-alley-v440";
...
var SHELL = [
  ...
  "./icons/icon-192.png?v=440",
  "./icons/icon-512.png?v=440",
  "./icons/icon-192-maskable.png?v=440",
  "./icons/icon-512-maskable.png?v=440",
  "./icons/apple-touch-icon.png?v=440",
