 ...
 */
var CACHE_VERSION = "lantern-alley-v356";
...
var SHELL = [
  ...
  "./icons/icon-192.png?v=356",
  "./icons/icon-512.png?v=356",
  "./icons/icon-192-maskable.png?v=356",
  "./icons/icon-512-maskable.png?v=356",
  "./icons/apple-touch-icon.png?v=356",
