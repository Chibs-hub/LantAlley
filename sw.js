 ...
 */
var CACHE_VERSION = "lantern-alley-v436";
...
var SHELL = [
  ...
  "./icons/icon-192.png?v=428",
  "./icons/icon-512.png?v=428",
  "./icons/icon-192-maskable.png?v=428",
  "./icons/icon-512-maskable.png?v=428",
  "./icons/apple-touch-icon.png?v=428",
