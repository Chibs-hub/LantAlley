 ...
 */
var CACHE_VERSION = "lantern-alley-v411";
...
var SHELL = [
  ...
  "./icons/icon-192.png?v=411",
  "./icons/icon-512.png?v=411",
  "./icons/icon-192-maskable.png?v=411",
  "./icons/icon-512-maskable.png?v=411",
  "./icons/apple-touch-icon.png?v=411",
