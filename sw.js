 ...
 */
var CACHE_VERSION = "lantern-alley-v402";
...
var SHELL = [
  ...
  "./icons/icon-512.png?v=402",
  "./icons/icon-192-maskable.png?v=402",
  "./icons/icon-512-maskable.png?v=402",
  "./icons/apple-touch-icon.png?v=402",
