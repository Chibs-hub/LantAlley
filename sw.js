 ...
 */
var CACHE_VERSION = "lantern-alley-v344";
...
var SHELL = [
  ...
  "./icons/icon-192.png?v=344",
  "./icons/icon-512.png?v=344",
  "./icons/icon-192-maskable.png?v=344",
  "./icons/icon-512-maskable.png?v=344",
  "./icons/apple-touch-icon.png?v=344",
