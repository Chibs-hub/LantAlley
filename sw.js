 ...
 */
var CACHE_VERSION = "lantern-alley-v354";
...
var SHELL = [
  ...
  "./icons/icon-192.png?v=354",
  "./icons/icon-512.png?v=354",
  "./icons/icon-192-maskable.png?v=354",
  "./icons/icon-512-maskable.png?v=354",
  "./icons/apple-touch-icon.png?v=354",
