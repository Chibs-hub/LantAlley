 ...
 */
var CACHE_VERSION = "lantern-alley-v417";
...
var SHELL = [
  ...
  "./icons/icon-192.png?v=417",
  "./icons/icon-512.png?v=417",
  "./icons/icon-192-maskable.png?v=417",
  "./icons/icon-512-maskable.png?v=417",
  "./icons/apple-touch-icon.png?v=417",
