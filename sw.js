 ...
 */
var CACHE_VERSION = "lantern-alley-v419";
...
var SHELL = [
  ...
  "./icons/icon-192.png?v=419",
  "./icons/icon-512.png?v=419",
  "./icons/icon-192-maskable.png?v=419",
  "./icons/icon-512-maskable.png?v=419",
  "./icons/apple-touch-icon.png?v=419",
