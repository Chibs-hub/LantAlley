 ...
 */
var CACHE_VERSION = "lantern-alley-v348";
...
var SHELL = [
  ...
  "./icons/icon-192.png?v=348",
  "./icons/icon-512.png?v=348",
  "./icons/icon-192-maskable.png?v=348",
  "./icons/icon-512-maskable.png?v=348",
  "./icons/apple-touch-icon.png?v=348",
