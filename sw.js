 ...
 */
var CACHE_VERSION = "lantern-alley-v410";
...
var SHELL = [
  ...
  "./icons/icon-192.png?v=410",
  "./icons/icon-512.png?v=410",
  "./icons/icon-192-maskable.png?v=410",
  "./icons/icon-512-maskable.png?v=410",
  "./icons/apple-touch-icon.png?v=410",
