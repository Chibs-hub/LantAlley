 ...
 */
var CACHE_VERSION = "lantern-alley-v447";// Fix: the kotatsu's rear cushions sit behind the table again, as they did before v401.
...
var SHELL = [
  ...
  "./icons/icon-192.png?v=447",
  "./icons/icon-512.png?v=447",
  "./icons/icon-192-maskable.png?v=447",
  "./icons/icon-512-maskable.png?v=447",
  "./icons/apple-touch-icon.png?v=447",
