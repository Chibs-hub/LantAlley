 ...
 */
var CACHE_VERSION = "lantern-alley-v340";
...
var SHELL = [
  ...
  "./icons/icon-512.png?v=340",
  "./icons/icon-192-maskable.png?v=340",
  "./icons/icon-512-maskable.png?v=340",
  "./icons/apple-touch-icon.png?v=340",
