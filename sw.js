 ...
 */
var CACHE_VERSION = "lantern-alley-v401";
...
var SHELL = [
  ...
  "./icons/icon-192.png?v=401",
  "./icons/icon-512.png?v=401",
  "./icons/icon-192-maskable.png?v=401",
  "./icons/icon-512-maskable.png?v=401",
  "./icons/apple-touch-icon.png?v=401",
