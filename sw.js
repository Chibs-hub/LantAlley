 ...
 */
var CACHE_VERSION = "lantern-alley-v424";
...
var SHELL = [
  ...
  "./icons/icon-192.png?v=424",
  "./icons/icon-512.png?v=424",
  "./icons/icon-192-maskable.png?v=424",
  "./icons/icon-512-maskable.png?v=424",
  "./icons/apple-touch-icon.png?v=424",
