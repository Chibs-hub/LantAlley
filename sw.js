 ...
 */
var CACHE_VERSION = "lantern-alley-v415";
...
var SHELL = [
  ...
  "./icons/icon-192.png?v=415",
  "./icons/icon-512.png?v=415",
  "./icons/icon-192-maskable.png?v=415",
  "./icons/icon-512-maskable.png?v=415",
  "./icons/apple-touch-icon.png?v=415",
