 ...
 */
var CACHE_VERSION = "lantern-alley-v439";
...
var SHELL = [
  ...
  "./icons/icon-192.png?v=439",
  "./icons/icon-512.png?v=439",
  "./icons/icon-192-maskable.png?v=439",
  "./icons/icon-512-maskable.png?v=439",
  "./icons/apple-touch-icon.png?v=439",
