 ...
 */
var CACHE_VERSION = "lantern-alley-v454";// New words are taught when their guest comes; training shows tasks left.
...
var SHELL = [
  ...
  "./icons/icon-192.png?v=454",
  "./icons/icon-512.png?v=454",
  "./icons/icon-192-maskable.png?v=454",
  "./icons/icon-512-maskable.png?v=454",
  "./icons/apple-touch-icon.png?v=454",
