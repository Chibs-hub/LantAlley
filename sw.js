 ...
 */
var CACHE_VERSION = "lantern-alley-v362";
...
var SHELL = [
  ...
  "./icons/icon-192.png?v=362",
  "./icons/icon-512.png?v=362",
  "./icons/icon-192-maskable.png?v=362",
  "./icons/icon-512-maskable.png?v=362",
  "./icons/apple-touch-icon.png?v=362",
