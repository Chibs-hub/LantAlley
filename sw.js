 ...
 */
var CACHE_VERSION = "lantern-alley-v360";
...
var SHELL = [
  ...
  "./icons/icon-512.png?v=360",
  "./icons/icon-192-maskable.png?v=360",
  "./icons/icon-512-maskable.png?v=360",
  "./icons/apple-touch-icon.png?v=360",
