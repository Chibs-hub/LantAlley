 ...
 */
var CACHE_VERSION = "lantern-alley-v393";
// Fix: the byobu and the window sill can no longer be placed through each other.
...
var SHELL = [
  ...
  "./icons/icon-192.png?v=393",
  "./icons/icon-512.png?v=393",
  "./icons/icon-192-maskable.png?v=393",
  "./icons/icon-512-maskable.png?v=393",
  "./icons/apple-touch-icon.png?v=393",
