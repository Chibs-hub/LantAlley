 ...
 */
var CACHE_VERSION = "lantern-alley-v389";
...
var SHELL = [
  ...
  "./icons/icon-192.png?v=389",
  "./icons/icon-512.png?v=389",
  "./icons/icon-192-maskable.png?v=389",
  "./icons/icon-512-maskable.png?v=389",
  "./icons/apple-touch-icon.png?v=389",
