 ...
 */
var CACHE_VERSION = "lantern-alley-v427";
...
var SHELL = [
  ...
  "./icons/icon-192.png?v=427",
  "./icons/icon-512.png?v=427",
  "./icons/icon-192-maskable.png?v=427",
  "./icons/icon-512-maskable.png?v=427",
  "./icons/apple-touch-icon.png?v=427",
