 ...
 */
var CACHE_VERSION = "lantern-alley-v444";
...
var SHELL = [
  ...
  "./icons/icon-192.png?v=444",
  "./icons/icon-512.png?v=444",
  "./icons/icon-192-maskable.png?v=444",
  "./icons/icon-512-maskable.png?v=444",
  "./icons/apple-touch-icon.png?v=444",
