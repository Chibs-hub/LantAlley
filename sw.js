 ...
 */
var CACHE_VERSION = "lantern-alley-v399";
// Fix: pets appear at their own resting spots instead of stacked on the doorway.
...
var SHELL = [
  ...
  "./icons/icon-192.png?v=399",
  "./icons/icon-512.png?v=399",
  "./icons/icon-192-maskable.png?v=399",
  "./icons/icon-512-maskable.png?v=399",
  "./icons/apple-touch-icon.png?v=399",
