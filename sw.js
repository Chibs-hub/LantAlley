 ...
 */
var CACHE_VERSION = "lantern-alley-v400";
...
var SHELL = [
  ...
  "./icons/icon-192.png?v=400",
  "./icons/icon-512.png?v=400",
  "./icons/icon-192-maskable.png?v=400",
  "./icons/icon-512-maskable.png?v=400",
  "./icons/apple-touch-icon.png?v=400",
