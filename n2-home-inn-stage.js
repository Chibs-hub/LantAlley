(function(root){
  ...
  var TEACHING = {
    ...
    "報告": {
      target:"w-houkoku",
      sentence:"ゆうべの部屋の様子を女将さんに報告してください。",
      pattern:"〜に〜を報告する"
    },
    "通知": {
      target:"w-tsuuchi",
    ...
    "満員": {
      target:"w-manin",
      sentence:"今夜の夕食会場は満員で、これ以上お客様を入れられません。",
      pattern:"〜は満員だ"
    },
    "清書": {
      target:"w-seisho",
    ...
    "務める": {
      ...
      sentence:"三日間の練習のあとも、宿の受付係を務めました。",
      focus:"務め",
      pattern:"〜を務める"
    }
  };
  ...
  var practiceWordChoice = [
    ...
    },
    {
      ...
      successReply:"はい、明日の朝食の配膳をお願いします。責任を持って仕事を受けるのが「引き受ける」です。"
    }
  ];
