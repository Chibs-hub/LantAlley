    ...
    days:[
      {day:1, mode:"learn", label:"改札に立つ", questions:[
        ...
        q1("station-e01-q01", "quick-response", "w-joukyaku", 8,
          ...
          {type:"quick-response", options:["乗客は一人もいません。","電車が来ません。","切符が売り切れました。","乗客がとても多いです。"], correctIndex:3},
        ...
        q1("station-e01-q02", "listening-task", "w-kaisatsu", 5,
          {jp:"改札に立ってください。どこに立ちますか。", audio:true},
          {type:"quick-response", options:["切符を見せて通る所","電車に乗る所","切符を買う所","荷物を置く所"], correctIndex:0},
        ...
        q1("station-e01-q03", "listening-point", "w-hougaku", 8,
          {jp:"あのお客様に、駅の方向をお伝えしてください。何を伝えますか。", audio:true},
          {type:"quick-response", options:["いくらかかるか","どちらへ向かうか","何時に着くか","誰が乗るか"], correctIndex:1},
      ...
      {day:2, mode:"practice", label:"上りと下り", questions:[
        ...
        q1("station-e01-q04", "listening-task", "w-nobori", 5,
          {jp:"上りの電車は二番線です。上りとはどちらのことですか。", audio:true},
          {type:"quick-response", options:["都心から離れる電車","止まっている電車","都心へ向かう電車","来ない電車"], correctIndex:2},
        ...
        q1("station-e01-q05", "listening-task", "w-kudari", 5,
          {jp:"このお客様は下りです。どちらへ向かうお客様ですか。", audio:true},
      ...
      {day:3, mode:"challenge", label:"終電が近い", questions:[
        ...
        q1("station-e01-q07", "reading", "w-jikoku", 120,
          ...
          {type:"evidence-choice", options:["十一時十分","十一時四十分","十時四十分","十一時五十分"], correctIndex:1},
        ...
        q1("station-e01-q08", "reading", "w-saishuu", 120,
          ...
          {type:"evidence-choice", options:["次の上りをお待ちいただきます","十一時五十分の電車をご案内します","待合室をご案内します","改札の外へお出しします"], correctIndex:2},
        ...
        q1("station-e01-q09", "listening-task", "w-jousha", 5,
          {jp:"ご乗車はお早めに。お客様に何をお願いしていますか。", audio:true},
          {type:"quick-response", options:["早く駅を出ること","早く切符を買うこと","早く並ぶこと","早く電車に乗ること"], correctIndex:3},
        ...
        q1("station-e01-q10", "integrated", "w-gesha", 12,
          ...
          {type:"quick-response", options:["そのままで結構です、お返しします。","下車は手前でも構いませんが、差額はお返しできません。","下車はできません。","切符を買い直してください。"], correctIndex:1},
    ...
    days:[
      {day:1, mode:"learn", label:"札を書く", questions:[
        ...
        q2("station-e02-q01", "orthography", "w-senro", 20,
          ...
          {type:"single-choice", options:["線路","線露","戦路","先路"], correctIndex:0},
        ...
        q2("station-e02-q02", "word-formation", "w-katamichi", 20,
          ...
          {type:"single-choice", options:["半","単","一","片"], correctIndex:3},
        ...
        q2("station-e02-q03", "sentence-building", "w-tetsuzuki", 30,
          ...
          {type:"sentence-order", options:["窓口で","手続きを","前日までに","お使いになる"], correctIndex:2},
      ...
      {day:2, mode:"practice", label:"窓口を直す", questions:[
        ...
        q2("station-e02-q04", "orthography", "w-madoguchi", 20,
          ...
          {type:"single-choice", options:["窓後","窓口","間戸口","窓門"], correctIndex:1},
        ...
        q2("station-e02-q05", "word-formation", "w-tsuukin", 20,
          ...
          {type:"single-choice", options:["通","往","出","上"], correctIndex:0},
        ...
        q2("station-e02-q06", "text-grammar", "w-kinyuu", 120,
          ...
          {type:"single-choice", options:["提出","乗車","相談","記入"], correctIndex:3},
      ...
      {day:3, mode:"challenge", label:"書き付けを閉じる", questions:[
        ...
        q2("station-e02-q07", "sentence-building", "w-teishutsu", 30,
          ...
          {type:"sentence-order", options:["係の者に","お持ちになり","そのまま","窓口の"], correctIndex:2},
        ...
        q2("station-e02-q08", "text-grammar", "v-moushikomu", 120,
          ...
          {type:"single-choice", options:["記入する","申し込む","下車する","出発する"], correctIndex:1},
        ...
        q2("station-e02-q09", "reading", "w-nitei", 120,
          ...
          {type:"evidence-choice", options:["月曜と水曜","月曜だけ","木曜だけ","月曜と水曜と木曜"], correctIndex:0},
        ...
        q2("station-e02-q10", "listening-task", "w-soudan", 8,
          {jp:"決めかねているお客様には、まず相談に乗ってください。何をしますか。", audio:true},
          {type:"quick-response", options:["窓口を閉めます。","次のお客様を呼びます。","困りごとを聞いて一緒に考えます。","こちらで決めて渡します。"], correctIndex:2},
    ...
    days:[
      {day:1, mode:"learn", label:"風が強い", questions:[
        ...
        q3("station-e03-q01", "listening-point", "w-housou-2", 8,
          {jp:"今の放送を聞きましたか。何のことですか。", audio:true},
          {type:"quick-response", options:["電車の走る音","駅で流れる知らせの声","駅の掲示板の紙","改札の機械の音"], correctIndex:1},
        ...
        q3("station-e03-q02", "quick-response", "w-shirase", 8,
          ...
          {type:"quick-response", options:["下りにご案内します。","改札を閉めます。","お客様に知らせをお伝えします。","黙って待ちます。"], correctIndex:2},
        ...
        q3("station-e03-q03", "listening-task", "w-gyaku", 5,
          {jp:"そのお客様は逆の電車に乗ろうとしています。どういうことですか。", audio:true},
          {type:"quick-response", options:["一本後の電車","高い切符の電車","止まっている電車","行きたい方向と反対の電車"], correctIndex:3},
      ...
      {day:2, mode:"practice", label:"間隔があく", questions:[
        ...
        q3("station-e03-q04", "listening-point", "w-kankaku-2", 8,
          {jp:"電車の間隔があいています。どういうことですか。", audio:true},
          {type:"quick-response", options:["次の電車まで時間が長い","電車がとても混んでいる","電車が速く走る","駅が広い"], correctIndex:0},
        ...
        q3("station-e03-q05", "quick-response", "w-chikoku", 8,
          ...
          {type:"quick-response", options:["仕方がありません。","遅延の証明をお出しできます。","走れば間に合います。","私には分かりません。"], correctIndex:1},
        ...
        q3("station-e03-q06", "listening-task", "w-mukai", 5,
          {jp:"下りの乗り場は向かいのホームです。どこですか。", audio:true},
          {type:"quick-response", options:["改札の外","同じホームの端","線路をはさんだ反対側","階段の下"], correctIndex:2},
      ...
      {day:3, mode:"challenge", label:"終電が動くか", questions:[
        ...
        q3("station-e03-q08", "reading", "w-tsuugaku", 120,
          ...
          {type:"evidence-choice", options:["そのままお乗りになれます","別に運賃がかかります","通勤の定期券が要ります","お乗りになれません"], correctIndex:0},
        ...
        q3("station-e03-q09", "quick-response", "w-kakujitsu", 8,
          ...
          {type:"quick-response", options:["確実に動きます。","まだ確実とは申し上げられません。点検が終わり次第お知らせします。","動きません。","分かりません。"], correctIndex:1},
        ...
        q3("station-e03-q10", "integrated", "w-angai", 12,
          ...
          {type:"quick-response", options:["予定どおりでした。","まったく戻りませんでした。","やはり遅れましたね。","案外早く戻りましたね。"], correctIndex:3},
    ...
    days:[
      {day:1, mode:"learn", label:"ホームを回る", questions:[
        ...
        q4("station-e04-q01", "quick-response", "v-azukeru", 8,
          ...
          {type:"quick-response", options:["持ってお帰りください。","できません。","お預かりできます。","置いていってください。"], correctIndex:2},
        ...
        q4("station-e04-q02", "listening-task", "w-zaseki", 5,
          {jp:"座席の下も見てください。どこを見ますか。", audio:true},
          {type:"quick-response", options:["改札の下","客が座る所の下","階段の下","窓口の下"], correctIndex:1},
        ...
        q4("station-e04-q03", "listening-task", "v-todoku", 5,
          {jp:"落とし物が届いています。どういうことですか。", audio:true},
      ...
      {day:2, mode:"practice", label:"預かる", questions:[
        ...
        q4("station-e04-q04", "listening-point", "w-kakari", 8,
          {jp:"忘れ物の係を呼んでください。誰を呼びますか。", audio:true},
          {type:"quick-response", options:["お店の人","電車の運転士","近くのお客様","その仕事を受け持つ人"], correctIndex:3},
        ...
        q4("station-e04-q05", "listening-task", "w-fukin", 5,
          {jp:"三番線の付近を見てきてください。どこを見ますか。", audio:true},
          {type:"quick-response", options:["三番線の切符売り場","駅の外の道","三番線の近く一帯","二番線だけ"], correctIndex:2},
        ...
        q4("station-e04-q06", "text-grammar", "w-kinshi", 120,
          ...
          {type:"single-choice", options:["案内","禁止","放送","相談"], correctIndex:1},
      ...
      {day:3, mode:"challenge", label:"駅を閉める", questions:[
        ...
        q4("station-e04-q08", "reading", "w-keikaku", 120,
          ...
          {type:"evidence-choice", options:["三","一","二","四"], correctIndex:3},
        ...
        q4("station-e04-q09", "reading", "w-touchaku", 120,
          ...
          {type:"evidence-choice", options:["一つ","三つ","二つ","作りません"], correctIndex:2},
        ...
        q4("station-e04-q10", "integrated", "w-shupatsu", 12,
          ...
          {type:"quick-response", options:["明日の出発は七時からです。点検があるためです。","明日は動きません。","分かりません。","いつもどおり五時です。"], correctIndex:0},
