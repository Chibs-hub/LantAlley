...
4. Add `?skip=1` to land on the map in one click, skipping character selection and the Entrance - useful when testing anything past them (the home, the Inn, the map itself) without replaying both on every reload of a fresh save.
