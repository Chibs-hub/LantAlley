...
**Latest v414 status (2026-09-17):** the lesson path is now integrated into the
...
sequence. No new image asset was needed: the route is SVG and the signs are CSS.
