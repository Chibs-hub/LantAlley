    ...
    days:[
      {day:1, mode:"learn", label:"店を開ける", questions:[
        ...
        q1("market-e01-q02", "listening-task", "v-hakaru-3", 5,
          ...
          {type:"quick-response", options:["袋に入れます。","棚に戻します。","はかりに載せます。","値段を書きます。"], correctIndex:2},
        ...
        q1("market-e01-q03", "listening-task", "w-fukuro", 5,
          // As with the Inn's 鍵: the prompt named 袋 and then asked which
          // thing was meant, so the answer could be matched out of the
          // question. The prompt describes what the customer needs and the
          // option is the word.
          {jp:"コン：「お客様が買った物を持ち帰れるようにしてください。」何をお渡ししますか。", audio:true},
          {type:"quick-response", options:["お金","はかり","値段の札","袋"], correctIndex:3},
          {correct:"袋をお渡ししました。「袋」は、物を入れて持ち帰るものです。",
           incorrect:"買った物を入れて持ち帰るものは「袋」です。"},
      ...
      {day:2, mode:"practice", label:"勘定台", questions:[
        ...
        q1("market-e01-q04", "quick-response", "w-ryougae", 8,
          ...
          {type:"quick-response", options:["両替してまいります。","そのままお受けします。","重さを量ります。","お売りできません。"], correctIndex:0},
        ...
        q1("market-e01-q05", "listening-point", "w-kanjou", 8,
          ...
          {type:"quick-response", options:["品物を棚に並べます。","買った物の代金を数えます。","袋を配ります。","市を閉めます。"], correctIndex:1},
        ...
        q1("market-e01-q06", "reading", "w-goukei", 120,
          ...
          {type:"evidence-choice", options:["千七百円","千六百十円","千七百十円","千八百十円"], correctIndex:2},
      ...
      {day:3, mode:"challenge", label:"客の波", questions:[
        ...
        q1("market-e01-q08", "quick-response", "w-urikire", 8,
          ...
          {type:"quick-response", options:["申し訳ありません、売り切れです。","はい、すぐお持ちします。","両替してまいります。","値段は六百円です。"], correctIndex:0},
        ...
        q1("market-e01-q09", "listening-task", "v-shiharau", 8,
          ...
          {type:"quick-response", options:["品物を数えます。","お金を渡します。","お金を受け取ります。","袋に入れます。"], correctIndex:1},
        ...
        q1("market-e01-q10", "integrated", "w-genkin", 12,
          ...
          {type:"quick-response", options:["はい、後で結構です。","売り切れです。","値段は分かりません。","恐れ入りますが、現金でお願いしております。"], correctIndex:3},
    ...
    days:[
      {day:1, mode:"learn", label:"値札を書く", questions:[
        ...
        q2("market-e02-q01", "orthography", "w-shouhin", 20,
          ...
          {type:"single-choice", options:["消品","焼品","商品","賞品"], correctIndex:2},
        ...
        q2("market-e02-q02", "word-formation", "w-haitatsu", 20,
          ...
          {type:"single-choice", options:["代","料","賃","金"], correctIndex:1},
      ...
      {day:2, mode:"practice", label:"送り状", questions:[
        ...
        q2("market-e02-q04", "orthography", "w-souko", 20,
          ...
          {type:"single-choice", options:["蔵庫","倉個","創庫","倉庫"], correctIndex:3},
        ...
        q2("market-e02-q05", "word-formation", "w-yuuryou", 20,
          ...
          {type:"single-choice", options:["無","別","有","未"], correctIndex:2},
        ...
        q2("market-e02-q06", "text-grammar", "w-banchi", 120,
          {jp:"【送り状の書き方】\nお届け先は、町の名前だけでなく（　　）まで書いてください。\n※ 町の名前だけでは、同じ名前のお宅がいくつもあります。\n※ （　　）が分からないときは、お客様にその場で伺ってください。\n（　　）に入る言葉はどれですか。"},
          {type:"single-choice", options:["値段","番地","重さ","種類"], correctIndex:1},
      ...
      {day:3, mode:"challenge", label:"帳面を閉じる", questions:[
        ...
        q2("market-e02-q07", "sentence-building", "w-yosan", 30,
          ...
          {type:"sentence-order", options:["これ以上","予算が","ないので","決まっていて"], correctIndex:0},
        ...
        q2("market-e02-q08", "text-grammar", "w-waribiki", 120,
        ...
        q2("market-e02-q09", "reading", "w-keisan", 120,
          ...
          {type:"evidence-choice", options:["五千七百三十円","五千八百三十円","五千六百三十円","五千五百三十円"], correctIndex:2},
          {correct:"五千六百三十円です。二千八百円と三千円と三十円を足して、二百円お引きしました。",
           incorrect:"果実で二千八百円、弁当で三千円、袋で三十円です。そこから百円ずつ二組分お引きします。"},
        ...
        q2("market-e02-q10", "listening-task", "w-shurui", 8,
          ...
          {type:"quick-response", options:["同じ果実どうしを集めます。","倉庫へ運びます。","全部袋に入れます。","値段の高い順に並べます。"], correctIndex:0},
    ...
    days:[
      {day:1, mode:"learn", label:"提灯がともる", questions:[
        ...
        q3("market-e03-q01", "quick-response", "w-konzatsu", 8,
          ...
          {type:"quick-response", options:["売り切れました。","誰もいません。","静かになりました。","かなり混雑しています。"], correctIndex:3},
        ...
        q3("market-e03-q02", "listening-point", "w-gyouretsu", 8,
          ...
          {type:"quick-response", options:["並んでいる人の一番後ろ","店の中","並んでいる人の一番前","倉庫の前"], correctIndex:0},
        ...
        q3("market-e03-q03", "quick-response", "v-susumeru", 8,
          ...
          {type:"quick-response", options:["どれも同じです。","今日は果実がおすすめです。","ご自分でお選びください。","分かりません。"], correctIndex:1},
      ...
      {day:2, mode:"practice", label:"人が並ぶ", questions:[
        ...
        q3("market-e03-q04", "listening-task", "w-sentaku", 5,
          ...
          {type:"quick-response", options:["品物を片付けます。","次のお客様を呼びます。","お客様が選ぶまで待ちます。","こちらで決めて渡します。"], correctIndex:2},
        ...
        q3("market-e03-q05", "quick-response", "w-shinsen", 8,
          ...
          {type:"quick-response", options:["かなり前の物です。","分かりかねます。","売り切れです。","今朝とれたばかりで、新鮮です。"], correctIndex:3},
        ...
        q3("market-e03-q06", "reading", "w-houfu", 120,
          ...
          {type:"evidence-choice", options:["果実だけ","弁当だけ","果実と袋","果実と弁当"], correctIndex:0},
      ...
      {day:3, mode:"challenge", label:"波が高い", questions:[
        ...
        q3("market-e03-q07", "reading", "w-fusoku", 120,
          ...
          {type:"evidence-choice", options:["果実と弁当","弁当と袋","袋だけ","三つとも"], correctIndex:1},
        ...
        q3("market-e03-q08", "listening-task", "v-kakaeru", 5,
          ...
          {type:"quick-response", options:["肩に載せて持ちます。","指先でつまみます。","両腕でかかえて持ちます。","床を滑らせます。"], correctIndex:2},
        ...
        q3("market-e03-q09", "listening-task", "v-katsugu", 5,
          ...
          {type:"quick-response", options:["はかりに載せます。","袋に入れます。","両腕でかかえます。","肩に載せて持ちます。"], correctIndex:3},
    ...
    days:[
      {day:1, mode:"learn", label:"売れ残りを数える", questions:[
        ...
        q4("market-e04-q01", "quick-response", "v-amaru", 8,
          {jp:"弁当を二十四個作って、二十三個売れました。店主：「弁当はどうなりましたか。」何と言いますか。", audio:true},
          {type:"quick-response", options:["一つ余りました。","全部売り切れました。","一つ足りません。","二十四個余りました。"], correctIndex:0},
          {correct:"数が合いました。「余る」は、使い切らずに残ることです。",
           incorrect:"二十四個のうち二十三個売れましたから、残りは一つです。"},
        ...
        q4("market-e04-q02", "listening-task", "v-tsumeru", 5,
          ...
          {type:"quick-response", options:["値段を書きます。","果実を並べ直します。","箱を捨てます。","箱にすき間なく入れます。"], correctIndex:3},
        ...
        q4("market-e04-q03", "listening-task", "v-tsumu", 5,
          ...
          {type:"quick-response", options:["箱を横に並べます。","箱を開けます。","箱を上へ重ねます。","箱を運び出します。"], correctIndex:2},
      ...
      {day:2, mode:"practice", label:"台を片付ける", questions:[
        ...
        q4("market-e04-q04", "quick-response", "v-katazuku", 8,
          ...
          {type:"quick-response", options:["まだ始めていません。","こちらは片付きました。","品物が足りません。","混雑しています。"], correctIndex:1},
        ...
        q4("market-e04-q05", "listening-point", "w-hahen", 8,
          ...
          {type:"quick-response", options:["割れて散らばったかけら","まだ割れていない皿","売れ残った弁当","お客様の行列"], correctIndex:0},
        ...
        q4("market-e04-q06", "text-grammar", "w-shidai", 120,
          {jp:"【店じまいの手順】\n台の上を片付け（　　）、帳面をお持ちください。\n※ 片付けの途中で帳面を開くと、数が合わなくなります。\n※ 終わってから、その足でお持ちください。\n（　　）に入る言葉はどれですか。"},
          {type:"single-choice", options:["たびに","ながら","つつ","次第"], correctIndex:3},
      ...
      {day:3, mode:"challenge", label:"帳面を閉じる", questions:[
        ...
        q4("market-e04-q07", "text-grammar", "v-haraikomu", 120,
          {jp:"【売り上げの納め方】\n今夜の売り上げは、明日の朝までに店の口座へ（　　）ください。\n※ 手元に置いたままにしないでください。\n※ 明日の朝、口座の控えを店主にお見せください。\n（　　）に入る言葉はどれですか。"},
          {type:"single-choice", options:["受け取って","数え直して","払い込んで","取り替えて"], correctIndex:2},
        ...
        q4("market-e04-q09", "reading", "w-kaikei", 120,
          ...
          {type:"evidence-choice", options:["三千三百三十円","二千三百三十円","四千三百三十円","三千六百三十円"], correctIndex:0},
        ...
        q4("market-e04-q10", "integrated", "v-ureru", 12,
          {jp:"店主：「今夜はどうでしたか。」弁当は二十四個のうち二十三個、果実は三十箱のうち二十八箱でした。何と言いますか。", audio:true},
          {type:"quick-response", options:["分かりません。","弁当だけ残りました。","どちらもよく売れました。","どちらも売れませんでした。"], correctIndex:2},
