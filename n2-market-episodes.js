    ...
    days:[
      {day:1, mode:"learn", label:"店を開ける", questions:[
        ...
        q1("market-e01-q02", "listening-task", "v-hakaru-3", 5,
          ...
          {type:"quick-response", options:["棚に戻します。","値段を書きます。","はかりに載せます。","袋に入れます。"], correctIndex:2},
      ...
      {day:2, mode:"practice", label:"勘定台", questions:[
        ...
        q1("market-e01-q05", "listening-point", "w-kanjou", 8,
          ...
          {type:"quick-response", options:["袋を配ります。","買った物の代金を数えます。","市を閉めます。","品物を棚に並べます。"], correctIndex:1},
    ...
    days:[
      {day:1, mode:"learn", label:"値札を書く", questions:[
        ...
        q2("market-e02-q02", "word-formation", "w-haitatsu", 20,
          ...
          {type:"single-choice", options:["賃","料","金","代"], correctIndex:1},
      ...
      {day:2, mode:"practice", label:"送り状", questions:[
        ...
        q2("market-e02-q04", "orthography", "w-souko", 20,
          ...
          {type:"single-choice", options:["創庫","蔵庫","倉個","倉庫"], correctIndex:3},
        ...
        q2("market-e02-q05", "word-formation", "w-yuuryou", 20,
          ...
          {type:"single-choice", options:["別","未","有","無"], correctIndex:2},
        ...
        q2("market-e02-q06", "text-grammar", "w-banchi", 90,
          ...
          {type:"single-choice", options:["種類","番地","値段","重さ"], correctIndex:1},
      ...
      {day:3, mode:"challenge", label:"帳面を閉じる", questions:[
        ...
        q2("market-e02-q07", "sentence-building", "w-yosan", 30,
          ...
          {type:"sentence-order", options:["これ以上","ないので","決まっていて","予算が"], correctIndex:0},
    ...
    days:[
      ...
      {day:2, mode:"practice", label:"人が並ぶ", questions:[
        ...
        q3("market-e03-q05", "quick-response", "w-shinsen", 8,
          ...
          {type:"quick-response", options:["売り切れです。","かなり前の物です。","分かりかねます。","今朝とれたばかりで、新鮮です。"], correctIndex:3},
      ...
      {day:3, mode:"challenge", label:"波が高い", questions:[
        ...
        q3("market-e03-q07", "reading", "w-fusoku", 120,
          ...
          {type:"evidence-choice", options:["三つとも","弁当と袋","果実と弁当","袋だけ"], correctIndex:1},
        ...
        q3("market-e03-q08", "listening-task", "v-kakaeru", 5,
          ...
          {type:"quick-response", options:["床を滑らせます。","肩に載せて持ちます。","両腕でかかえて持ちます。","指先でつまみます。"], correctIndex:2},
    ...
    days:[
      {day:1, mode:"learn", label:"売れ残りを数える", questions:[
        ...
        q4("market-e04-q01", "quick-response", "v-amaru", 8,
          ...
          {type:"quick-response", options:["一つ余りました。","二十四つ余りました。","全部売り切れました。","一つ足りません。"], correctIndex:0},
        ...
        q4("market-e04-q03", "listening-task", "v-tsumu", 5,
          ...
          {type:"quick-response", options:["箱を開けます。","箱を運び出します。","箱を上へ重ねます。","箱を横に並べます。"], correctIndex:2},
      ...
      {day:2, mode:"practice", label:"台を片付ける", questions:[
        ...
        q4("market-e04-q04", "quick-response", "v-katazuku", 8,
          ...
          {type:"quick-response", options:["混雑しています。","こちらは片付きました。","まだ始めていません。","品物が足りません。"], correctIndex:1},
        ...
        q4("market-e04-q05", "listening-point", "w-hahen", 8,
          ...
          {type:"quick-response", options:["割れて散らばったかけら","売れ残った弁当","お客様の行列","まだ割れていない皿"], correctIndex:0},
      ...
      {day:3, mode:"challenge", label:"帳面を閉じる", questions:[
        ...
        q4("market-e04-q09", "reading", "w-kaikei", 120,
          ...
          {type:"evidence-choice", options:["三千三百三十円","三千六百三十円","二千三百三十円","四千三百三十円"], correctIndex:0},
